...
<!-- Mirrored from product.quanten-x.online/tradegenius/user/login by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 28 May 2024 13:24:19 GMT -->
                ...
                <ul class="nav-menu">
                    ...
                    <li>
                        <div class="btn__grp ms-lg-3">
                                                            ...
                                                            <a href="login.php" class="cmn--btn">Get Started</a>
                                                    </div>
                    </li>
                </ul>
            </div>
            ...
            <div class="accounts-inner__wrapper bg--section">
                <div class="accounts-left">
                    <div class="accounts-left-content">
                        ...
                        <div class="sec-title">
                            <div class="title">Sign in to Trade Genius</div>
...
<p class="m-0 text-danger"></p>
                                ...
                                <input type="email" name="email" id="username" class="form-control" value="user@gmail.com">
                            </div>
                            <div class="col-sm-12">
                                <label for="password" class="form-label">Your Password</label>
                                <input type="password" name="pass" id="password" class="form-control" value="123456">
                            </div>
                            <div class="col-12 mt-2">
                                <div class="d-flex flex-wrap justify-content-between">
                                    ...
                                    <a href="#" class="text--base">Forget Password</a>
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <button class="cmn--btn"type="submit" name="submit">Sign In</button>
                            </div>
                            <div class="col-sm-12">
                                Not Registered Yet ? <a href="register.php" class="text--base">Create an
                                    Account</a>
                            </div>
                        </form>
                    </div>
...
<!-- Mirrored from product.quanten-x.online/tradegenius/user/login by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 28 May 2024 13:24:21 GMT -->
</html>
